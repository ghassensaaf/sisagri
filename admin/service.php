                                            ...
                                            <div class="row mb-1">
                                                <div class="col-5 offset-1">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="nom_ass" name="titre" type="text"  class="form-control" value="" placeholder=""></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <div class="form-group">
                                                        <div style="text-align: center;"><label for="text" class="control-label mb-1">Text</label></div>
                                                        <textarea id="pre_ass" name="text" type="text" class="form-control" value="" placeholder=""></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <img width="100%" src="../assets/img/gallery/'.$item["img"].'" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="container">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="addC" action="inc/forms.php" enctype="multipart/form-data" onsubmit="return submit_form(this)" method="post">
                                            ...
                                            <div class="container-fluid">
                                                <div class="row mb-1">
                                                    <div class="col-5 offset-1">
                                                        <div class="form-group">
                                                            <div style="text-align: center;"><label for="titre" class="control-label mb-1">Titre</label></div>
                                                            <textarea id="nom_ass" name="titre" type="text"  class="form-control"  placeholder="" >'.$item["titre"].' </textarea>
                                                    ...
                                                    <div class="col-5">
                                                        <div class="form-group">
                                                            <div style="text-align: center;"><label for="text" class="control-label mb-1">Text</label></div>
                                                            <textarea id="pre_ass" name="text" type="text" class="form-control" value="" placeholder="">'.$item["text"].'</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-1">
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            <input type="submit" class="btn btn-outline-success" value="Ajouter">
                                            <input type="hidden" name="form" value="editService">
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <form action="inc/forms.php" method="post">
                                            ...
                                            <input type="hidden" name="id" value="'.$item["id"].'">
                                            <input type="hidden" name="form" value="delService">
