                                        ...
                                        <div class="modal-body mx-3">
                                            <div class="container-fluid">
                                                <div class="row mb-1">
                                                    ...
                                                    <div class="col-5">
                                                        <div class="form-group">
                                                            <div style="text-align: center;"><label for="slogan" class="control-label mb-1">Text</label></div>
                                                            <input id="pre_ass" name="text" type="text" class="form-control" value="" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-1">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <img width="100%" src="../assets/img/hero/'.$item["img"].'" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="container">
